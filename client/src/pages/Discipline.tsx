...
export default function DisciplinePage() {
  ...
  const violations = trpc.admin.listViolations.useQuery(undefined, {
    enabled: isAdmin,
  });
                ...
                <TableRow key={v.id}>
                  ...
                  <TableCell>
                    <Badge variant="destructive">
                      <AlertTriangle className="w-3 h-3 mr-1" /> {v.type}
                    </Badge>
                  </TableCell>
                  ...
                  <TableCell>
                    <Badge
                      variant={v.status === "open" ? "secondary" : "outline"}
                    >
                      {v.status}
                    </Badge>
                  </TableCell>
                    ...
                    <div className="flex gap-1">
                      {v.status === "open" && (
                        <Button
                          ...
                          onClick={() =>
                            resolveViolation.mutate({ violationId: v.id })
                          }
                        >
                      ...
                      <Button
                        ...
                        onClick={() => setSuspendUserId(v.userId)}
                      >
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction
              ...
              onClick={() =>
                suspendUserId && suspendUser.mutate({ userId: suspendUserId })
              }
            >
              Suspend
            </AlertDialogAction>
